...
- Verified translucent detail header during scrolling, fourteen Home bars and larger plus, unclipped detail footer, zero-history metrics, and no example prompts.
